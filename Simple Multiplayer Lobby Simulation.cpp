...
int main()
{
    ...
    */
    ...
    cout << "------Welcome to Our Multiplayer Lobby Simulator------" << endl;

    cout << "Choose max player pool count: ";
    cin >> maxPoolCount;
    cout << "The max amount of players you can add is: " << maxPoolCount << endl;

    do {
        cout << "Choose max player lobby count: ";
        cin >> maxLobbyCount;
    } while (maxLobbyCount > maxPoolCount);
    cout << "The max amount of players you can add to lobby and queue is: " << maxLobbyCount << endl;
